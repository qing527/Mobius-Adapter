...
from .custom_utils.representation import logPolarFilters, logPolarFiltersLT, rsConvCoeffLT, linearizeLogPolar, mellinQuadrature, t, sigma1, sigma2

from .custom_utils.rs_diff import rsDirichlet
from .custom_utils.operators import operators
...
class convBlockReduceLT(nn.Module):
    ...
    def forward(self, g):
        ...
        ## Reshape, multiply by appropriate scale, then reduce 乘积再求和，这个是完成卷积的过程
        # g: b x m x l
